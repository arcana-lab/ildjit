...
**/
#define METH_MAX_VAR(method) method->getMaxVariables(method)
...
**/
#define METH_MAX_VAR_SET(method,new_value) method->setMaxVariables(method,new_value)
...
**/
#define INST_TYPE(method,instruction) IRMETHOD_getInstructionType(instruction)
...
**/
#define INST_N_PAR(method,instruction) method->getInstrParametersNumber(method,instruction)
...
**/
#define PREV_INST(method,instruction) method->getPrevInstruction(method,instruction)
...
**/
#define NEXT_INST(method,instruction) method->getNextInstruction(method,instruction)
...
**/
#define GET_PREDECESSOR(method,instruction,prevPredecessor) IRMETHOD_getPredecessorInstruction(method,instruction,prevPredecessor)
...
**/
#define GET_SUCCESSOR(method,instruction,prevSuccessor) IRMETHOD_getSuccessorInstruction(method,instruction,prevSuccessor)
...
**/
#define GET_BB(method,instruction) IRMETHOD_getTheBasicBlockIncludesInstruction(method,instruction)
...
**/
#define NEW_INST(method) IRMETHOD_newInstruction(method)
...
**/
#define CLONE_INST(method,instruction) IRMETHOD_cloneInstruction(method,instruction)
...
**/
#define DEL_INST(method,instruction) IRMETHOD_deleteInstruction(method,instruction)
...
**/
#define NEW_INST_AFTER(method,previous) IRMETHOD_newInstructionAfter(method,previous)
...
**/
#define MOVE_INST_AFTER(method,instruction,previous) IRMETHOD_moveInstructionAfter(method,instruction,previous)
...
**/
#define NEW_INST_BEFORE(method,following) IRMETHOD_newInstructionBefore(method,following)
...
**/
#define INST_TYPE_SET(method,instruction,new_type) IRMETHOD_setInstructionType(method,instruction,new_type);
...
**/
#define LABEL_AT(method,labelID) IRMETHOD_getLabelInstruction(method,labelID)
...
**/
#define NEW_LABEL(method) IRMETHOD_newLabelID(method)
...
**/
#define IS_A_JUMP(method,instruction) IRMETHOD_isAJumpInstruction(method,instruction)
...
**/
#define IS_A_PREDOM(method,dominator,dominated) IRMETHOD_isInstructionAPredominator(method,dominator,dominated)
...
**/
#define PAR_1(method,instruction) method->getInstrPar1(instruction)
...
**/
#define PAR_1_TYPE(method,instruction) method->getInstrPar1Type(instruction)
...
**/
#define PAR_1_VALUE(method,instruction) method->getInstrPar1Value(instruction)
...
**/
#define PAR_1_VALUE_SET(method,instruction,new_value) method->setInstrPar1Value(instruction,new_value)
...
**/
#define PAR_2(method,instruction) method->getInstrPar2(instruction)
...
**/
#define PAR_2_TYPE(method,instruction) method->getInstrPar2Type(instruction)
...
**/
#define PAR_2_VALUE(method,instruction) method->getInstrPar2Value(instruction)
...
**/
#define PAR_2_VALUE_SET(method,instruction,new_value) method->setInstrPar2Value(instruction,new_value)
...
**/
#define PAR_3(method,instruction) method->getInstrPar3(instruction)
...
**/
#define PAR_3_TYPE(method,instruction) method->getInstrPar3Type(instruction)
...
**/
#define PAR_3_VALUE(method,instruction) method->getInstrPar3Value(instruction)
...
**/
#define PAR_3_VALUE_SET(method,instruction,new_value) method->setInstrPar3Value(instruction,new_value)
...
**/
#define RES(method,instruction) method->getInstrResult(instruction)
...
**/
#define RES_TYPE(method,instruction) method->getInstrResult(instruction)->type
...
**/
#define RES_VALUE(method,instruction) method->getInstrResult(instruction)->value
...
**/
#define RES_VALUE_SET(method,instruction,new_value) method->setInstrResultValue(instruction,new_value)
...
**/
#define CALL_PAR_NUM(method,instruction) method->getCallParametersNumber(instruction)
...
**/
#define CALL_PAR_TYPE(method,instruction,nth) method->getCallParameterType(instruction,nth)
...
**/
#define CALL_PAR_VALUE(method,instruction,nth) method->getCallParameterValue(instruction,nth)
...
**/
#define CALL_PAR_VALUE_SET(method,instruction,nth,new_value) method->setCallParameterValue(instruction,nth,new_value)
