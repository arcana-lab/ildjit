//questo file � stato costruito prendendo da pnet-0.8.0/support/unicode.c le definizioni dei
//caratteri unicode con SMALL_UNICODE_TABLE=1 (IL_CONFIG_LATIN1 settato)
...
void ILUnicodeStringToUpper (JITINT16 *dest, const JITINT16 *src,
                             JITINT32 len) {
    JITINT16 ch;
...
void ILUnicodeStringToLower (JITINT16 *dest, const JITINT16 *src,
                             JITINT32 len) {
    JITINT16 ch;
...
JITINT32 ILUnicodeStringCompareIgnoreCase (const JITINT16 *str1,
        const JITINT16 *str2,
        JITINT32 len) {
    JITINT16 ch1;
    JITINT16 ch2;
...
JITINT32 ILUnicodeStringCompareNoIgnoreCase (const JITINT16 *str1,
        const JITINT16 *str2,
        JITINT32 len) {
    JITINT16 ch1;
    JITINT16 ch2;
