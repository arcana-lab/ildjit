 ...
 */
/**
   *@file type_spec_table_metadata.h
 */
#ifndef TYPE_SPEC_TABLE_METADATA_H
#define TYPE_SPEC_TABLE_METADATA_H
 ...
 */
typedef struct {
    t_row_type_spec_table   **table;
    JITUINT32 cardinality;
} t_type_spec_table;

/**
 * @brief Load the TypeSpec table
 *
...
/**
 * @brief Shutdown the TypeSpec table
 *
