...
int main (int argc, char * argv[]) {
    ...
    method.setInstrPar1(firstInstr, 20, 0, IROFFSET, IRINT32, 0, NULL);
    method.setInstrPar2(firstInstr, 40, 0, IROFFSET, IRINT32, 0, NULL);
    ...
    method.setInstrPar1(secondInstr, 2, 0, IROFFSET, IRINT32, 0, NULL);
    method.setInstrPar2(secondInstr, 5, 0, IROFFSET, IRINT32, 0, NULL);
    assert(method.getMaxVariables(&method) == 41);
    method.updateRootSet(&method);
    assert(method.getMaxVariables(&method) == 41);
